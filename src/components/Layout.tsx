  ...
  if (isMobile) {
    ...
    return (
      <div className="flex h-screen flex-col bg-secondary">
        ...
        {/* Scrollable main content — extra bottom padding reserves space beneath the floating nav + safe area */}
        <main id="main-content" className="flex-1 overflow-auto pb-[calc(4.5rem+env(safe-area-inset-bottom))]" aria-label="Main content">
          {children}
        </main>

        {/* Floating bottom navigation bar — fixed so it hovers over content; pb-safe extends into the home-indicator area */}
        <nav className="fixed bottom-0 inset-x-0 z-10 bg-card border-t border-border shadow-[0_-2px_8px_rgba(0,0,0,0.08)] pb-[env(safe-area-inset-bottom)]" aria-label="Bottom navigation">
