...
describe('Courses', () => {
    ...
    it('publishes and deletes a selected course from the detail dialog', async () => {
        ...
        expect(onUpdateCourse).toHaveBeenCalledWith('c1', expect.objectContaining({ published: true }))
        expect(toastSuccess).toHaveBeenCalledWith(
            'Course published',
    ...
    it('moves a published course back to draft', async () => {
        ...
        expect(onUpdateCourse).toHaveBeenCalledWith('c1', expect.objectContaining({ published: false }))
        expect(toastSuccess).toHaveBeenCalledWith(
