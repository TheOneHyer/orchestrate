...
const scoreSchema = z.object({
    score: z
        .number('Please enter a whole number between 0 and 100.')
        .int({ message: 'Please enter a whole number between 0 and 100.' })
        .min(0, { message: 'Please enter a whole number between 0 and 100.' })
        .max(100, { message: 'Please enter a whole number between 0 and 100.' })
        .optional(),
})
