...
/**
 * Render a dialog showing details for the currently selected workload recommendation.
 *
 * Displays the recommendation's title, description, type, priority, actionable status,
 * optional potential savings, and a list of affected trainers. If `recommendation` is
 * `null`, the component renders `null`.
 *
 * @param props - Component props controlling dialog state, the selected recommendation, user list, and optional action handlers.
 * @returns The dialog element for the recommendation details, or `null` when `recommendation` is `null`.
 */
