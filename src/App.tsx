...
/**
 * Normalize a navigation string and return null for empty or invalid inputs.
 *
 * @param value - The navigation string to parse and normalize.
 * @returns The normalized navigation target, or `null` if the input is empty or invalid.
 */
